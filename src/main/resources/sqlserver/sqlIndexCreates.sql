...
alter table benchmarksql.customer add constraint pk_customer 
  primary key nonclustered (c_w_id, c_d_id, c_id, c_last, c_first);
-- create clustered index idx_customer_c_last on benchmarksql.customer (c_w_id, c_d_id, c_id, c_last, c_first);
...
alter table benchmarksql.oorder add constraint pk_oorder 
  primary key nonclustered (o_w_id, o_d_id, o_c_id, o_id);
-- create clustered index idx_oorder_o_id on benchmarksql.oorder (o_w_id, o_d_id, o_c_id, o_id);
...
alter table benchmarksql.stock add constraint pk_stock
  primary key nonclustered (s_w_id, s_i_id, s_quantity);
-- create clustered index idx_stock_s_id on benchmarksql.stock (s_w_id, s_i_id, s_quantity);
